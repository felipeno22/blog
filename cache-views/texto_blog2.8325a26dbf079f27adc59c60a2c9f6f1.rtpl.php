<?php if(!class_exists('Rain\Tpl')){exit;}?>
   ...
   <article>
    ...
    <br>
        ...
        <p id="content_text"><?php echo htmlspecialchars( $cont["content_text"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>

 <div style="background:gray;padding:10px;">

<p></p><a href=""><?php echo htmlspecialchars( $cont["deslogin"], ENT_COMPAT, 'UTF-8', FALSE ); ?></a> às <?php echo htmlspecialchars( $cont["hora"], ENT_COMPAT, 'UTF-8', FALSE ); ?></p>
...
<div id="add_comments" >
    ...
    <input  type="text" id="input_comment" placeholder="digite um comentário" onclick="focus_input()" ></input>
