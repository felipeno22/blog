...
<form  id="idFormInfo" name="idFormInfo"  onsubmit="return insert_update_comment('update')"  class="formInfo" action="/updateComm/<?php echo htmlspecialchars( $comment["idcomment"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
	...
	<fieldset>
		...
		<legend>Detalhes do comentário </legend>
			...
			<label>Status: </label><br><input type="text" id="input_sts" name="input_sts" value="<?php echo htmlspecialchars( $comment["status_comment"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" disabled>
