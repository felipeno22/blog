...
$(document).ready(function() {
           ...
           if(totalPages < 5)
              blogsAdmin(iduser,1,totalPages,0)
           else
            blogsAdmin(iduser,1,5,0)
...
function blogsAdmin(iduser,page,aux,aux2){
  ...
  $.ajax({
      ...
      method:"GET",
       dataType: "json",
        data: { iduser: iduser ,page: page, aux: aux, aux2: aux2}
     ...
     console.log(result); 
      ...
      for(var i=0; i < result['blogs'].length; i++){
        ...
        var b= `<div class="content"  >
                     ...
                     <a href="/panel_contents/ ${result['blogs'][i]['idblog']}"><span> ${result['blogs'][i]['dtblog']}</span><br><br>  
                     ...
                     <div id="divtotalcont${result['blogs'][i]['idblog']}">
                            ...
                            <a id='lbltotalcont${result['blogs'][i]['idblog']}' href="/panel_contents/ ${result['blogs'][i]['idblog']}">contéudos</a>
                    </div>
         ...
         totalblogsAdmin(result['blogs'][i]['idblog'],`/panel_contents/ ${result['blogs'][i]['idblog']}`)
...
function totalblogsAdmin(idblog,url){
