...
$(document).ready(function() {
           ...
           if(totalPages < 5)
            contents_panel(idblog,1,totalPages,0)
           else
            contents_panel(idblog,1,5,0)
...
function contents_panel(idblog,page,aux,aux2){
     ...
     console.log(result); 
      ...
      for(var i=0; i < result['contents'].length; i++){
        ...
        var b= `<div class="content"  >
         ...
         totalcomms(result['contents'][i]['idcontent'],`/text_content/${result['contents'][i]['idcontent']}`)
...
function totalcomms(idcontent,url){
  //var idblog= document.getElementById("idblog").value;
